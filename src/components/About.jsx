        ...
        ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
            <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                <figure
                    data-aos='fade-up'
                    data-aos-delay='300'
                    className="flex flex-wrap justify-center gap-4 relative order-2 lg:order-1s">
                    <div className="relative w-75 h-75 lg:w-96 lg:h-96">
                        {/* Image */}
                        <div className="absolute -inset-6 lg:-inset-20
                        bg-linear-to-1 from-[#f97316] via-[#fb923c] to-[#f59e0b] rotate-12 star-shape z-0 "
                            data-aos='zoom-in'
                            data-aos-delay='600'>
                ...
                <article
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg
                        xl-text-xl mb-6 sm:mb-8 leading-relaxed bg-linear-to-r from-orange-900/10 to-orange-900/5
                        p-4 sm:p-6 rounded-xl sm:rounded-2xl backdrop-blur-sm ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}
                        data-aos='fade-up'
                        data-aos-delay='500'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi aut officiis eius voluptatem cupiditate debitis consequuntur recusandae itaque reiciendis mollitia. Sequi nesciunt ducimus placeat saepe eos, neque quis culpa ad.</p>
                    ...
                    <div className="flex flex-wrap justify-center
                        ...
                        <div className="text-center "
                            ...
                            data-aos-delay='600'
                        >
                            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange-400 ">1.5+</div>
                            <div className={`text-xs sm:text-sm lg:text-base 
                                    ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                                Year Experience</div>
                    ...
                    <button
                     className={`w-full sm:w-auto
                                     ...
                                     text-white border-0
                                    py-2 px-4 sm:px-6 hover:shodow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all
